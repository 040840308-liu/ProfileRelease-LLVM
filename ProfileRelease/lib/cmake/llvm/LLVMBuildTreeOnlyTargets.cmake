...
set_target_properties(llvm_gtest PROPERTIES
  ...
  INTERFACE_INCLUDE_DIRECTORIES "/home/test/workspace-15/llvm/llvm/utils/unittest/googletest/include;/home/test/workspace-15/llvm/llvm/utils/unittest/googlemock/include"
)
...
set_target_properties(LLVMHello PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "/home/test/workspace-15/llvm/build/lib/LLVMHello.so"
...
set_target_properties(LLVMTestingSupport PROPERTIES
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "LLVMSupport;llvm_gtest"
  IMPORTED_LOCATION_RELEASE "/home/test/workspace-15/llvm/build/lib/libLLVMTestingSupport.so.15"
  IMPORTED_SONAME_RELEASE "libLLVMTestingSupport.so.15"
  )
...
set_target_properties(FileCheck PROPERTIES
  IMPORTED_LOCATION_RELEASE "/home/test/workspace-15/llvm/build/bin/FileCheck"
  )
...
set_target_properties(llvm-PerfectShuffle PROPERTIES
  IMPORTED_LOCATION_RELEASE "/home/test/workspace-15/llvm/build/bin/llvm-PerfectShuffle"
  )
...
set_target_properties(count PROPERTIES
  IMPORTED_LOCATION_RELEASE "/home/test/workspace-15/llvm/build/bin/count"
  )
...
set_target_properties(not PROPERTIES
  IMPORTED_LOCATION_RELEASE "/home/test/workspace-15/llvm/build/bin/not"
  )
...
set_target_properties(UnicodeNameMappingGenerator PROPERTIES
  IMPORTED_LOCATION_RELEASE "/home/test/workspace-15/llvm/build/bin/UnicodeNameMappingGenerator"
  )
...
set_target_properties(yaml-bench PROPERTIES
  IMPORTED_LOCATION_RELEASE "/home/test/workspace-15/llvm/build/bin/yaml-bench"
  )
...
set_target_properties(SampleAnalyzerPlugin PROPERTIES
  IMPORTED_COMMON_LANGUAGE_RUNTIME_RELEASE ""
  IMPORTED_LOCATION_RELEASE "/home/test/workspace-15/llvm/build/lib/SampleAnalyzerPlugin.so"
  IMPORTED_NO_SONAME_RELEASE "TRUE"
  )
...
set_target_properties(CheckerDependencyHandlingAnalyzerPlugin PROPERTIES
  IMPORTED_COMMON_LANGUAGE_RUNTIME_RELEASE ""
  IMPORTED_LOCATION_RELEASE "/home/test/workspace-15/llvm/build/lib/CheckerDependencyHandlingAnalyzerPlugin.so"
  IMPORTED_NO_SONAME_RELEASE "TRUE"
  )
...
set_target_properties(CheckerOptionHandlingAnalyzerPlugin PROPERTIES
  IMPORTED_COMMON_LANGUAGE_RUNTIME_RELEASE ""
  IMPORTED_LOCATION_RELEASE "/home/test/workspace-15/llvm/build/lib/CheckerOptionHandlingAnalyzerPlugin.so"
  IMPORTED_NO_SONAME_RELEASE "TRUE"
  )
...
set_target_properties(BugpointPasses PROPERTIES
  IMPORTED_COMMON_LANGUAGE_RUNTIME_RELEASE ""
  IMPORTED_LOCATION_RELEASE "/home/test/workspace-15/llvm/build/lib/BugpointPasses.so"
  IMPORTED_NO_SONAME_RELEASE "TRUE"
  )
...
set_target_properties(lli-child-target PROPERTIES
  IMPORTED_LOCATION_RELEASE "/home/test/workspace-15/llvm/build/bin/lli-child-target"
  )
...
set_target_properties(llvm-jitlink-executor PROPERTIES
  IMPORTED_LOCATION_RELEASE "/home/test/workspace-15/llvm/build/bin/llvm-jitlink-executor"
  )
...
set_target_properties(obj2yaml PROPERTIES
  IMPORTED_LOCATION_RELEASE "/home/test/workspace-15/llvm/build/bin/obj2yaml"
  )
...
set_target_properties(yaml2obj PROPERTIES
  IMPORTED_LOCATION_RELEASE "/home/test/workspace-15/llvm/build/bin/yaml2obj"
  )
...
set_target_properties(Bye PROPERTIES
  IMPORTED_COMMON_LANGUAGE_RUNTIME_RELEASE ""
  IMPORTED_LOCATION_RELEASE "/home/test/workspace-15/llvm/build/lib/Bye.so"
  IMPORTED_NO_SONAME_RELEASE "TRUE"
  )
...
set_target_properties(TestPlugin PROPERTIES
  IMPORTED_COMMON_LANGUAGE_RUNTIME_RELEASE ""
  IMPORTED_LOCATION_RELEASE "/home/test/workspace-15/llvm/build/unittests/Passes/TestPlugin.so"
  IMPORTED_NO_SONAME_RELEASE "TRUE"
  )
...
set_target_properties(DoublerPlugin PROPERTIES
  IMPORTED_COMMON_LANGUAGE_RUNTIME_RELEASE ""
  IMPORTED_LOCATION_RELEASE "/home/test/workspace-15/llvm/build/unittests/Passes/DoublerPlugin.so"
  IMPORTED_NO_SONAME_RELEASE "TRUE"
  )
...
set_target_properties(llvm_gtest PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "/home/test/workspace-15/llvm/build/lib/libllvm_gtest.so.15"
  IMPORTED_SONAME_RELEASE "libllvm_gtest.so.15"
  )
...
set_target_properties(llvm_gtest_main PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "/home/test/workspace-15/llvm/build/lib/libllvm_gtest_main.so.15"
  IMPORTED_SONAME_RELEASE "libllvm_gtest_main.so.15"
  )
