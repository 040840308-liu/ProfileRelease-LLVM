...
set(LLVM_BUILD_BINARY_DIR "/home/test/workspace-15/llvm/build")
set(LLVM_BUILD_LIBRARY_DIR "/home/test/workspace-15/llvm/build/./lib")
set(LLVM_BUILD_MAIN_INCLUDE_DIR "/home/test/workspace-15/llvm/llvm/include")
set(LLVM_BUILD_MAIN_SRC_DIR "/home/test/workspace-15/llvm/llvm")
...
set(LLVM_INCLUDE_DIRS "/home/test/workspace-15/llvm/llvm/include;/home/test/workspace-15/llvm/build/include")
set(LLVM_LIBRARY_DIRS "/home/test/workspace-15/llvm/build/./lib")
...
set(LLVM_MAIN_INCLUDE_DIR "/home/test/workspace-15/llvm/llvm/include")
set(LLVM_LIBRARY_DIR "/home/test/workspace-15/llvm/build/./lib")

# This is a secondary one for generated files
set(LLVM_INCLUDE_DIR "/home/test/workspace-15/llvm/build/include")

set(LLVM_DEFINITIONS "-D_GNU_SOURCE -D_DEBUG -D__STDC_CONSTANT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_LIMIT_MACROS")
set(LLVM_BINARY_DIR "/home/test/workspace-15/llvm/build")
set(LLVM_CMAKE_DIR "/home/test/workspace-15/llvm/llvm/cmake/modules")
set(LLVM_TOOLS_BINARY_DIR "/home/test/workspace-15/llvm/build/./bin")
set(LLVM_HAVE_OPT_VIEWER_MODULES 0)
set(LLVM_CONFIGURATION_TYPES )
set(LLVM_ENABLE_SHARED_LIBS ON)

set(LLVM_DEFAULT_EXTERNAL_LIT "/home/test/workspace-15/llvm/build/./bin/llvm-lit")
set(LLVM_LIT_ARGS "-sv")

set(LLVM_HAVE_LIBXAR "")

if(NOT TARGET LLVMSupport)
  include("/home/test/workspace-15/llvm/build/lib/cmake/llvm/LLVMExports.cmake")
  include("/home/test/workspace-15/llvm/build/lib/cmake/llvm/LLVMBuildTreeOnlyTargets.cmake")
endif()
